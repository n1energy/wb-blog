...
#             namee="Test_article_2", body="hello_2", user=self.user_1
#         )
#         self.article_3 = Article.objects.create(
#             name="Test_article_3", body="hello_3", user=self.user_2
#         )
...
#         url = reverse("articles")
#         data = {"title": "Python 310", "body": "new release!", "user": self.user_2}
